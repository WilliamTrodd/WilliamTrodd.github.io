const Navbar = ({navOpen, setNavOpen}) => {
  return(
    <div className="flex items-center justify-between border-b border-color4 py-8">
      <a href="/">
      ...
      <nav>
        <section className="MOBILE-MENU flex lg:hidden">
          ...
          >
            <span className="block h-0.5 w-8 animate-pulse bg-color2"></span>
            <span className="block h-0.5 w-8 animate-pulse bg-color2"></span>
            <span className="block h-0.5 w-8 animate-pulse bg-color2"></span>
          </div>
