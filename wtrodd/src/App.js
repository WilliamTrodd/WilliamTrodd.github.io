...
const ProjectCard = (props) => (
  <div className="h-96 p-2 my-2 border w-80 border-gray-200 rounded-lg shadow-md">

    <div className="p-5 max-w-1/4 h-full flex flex-col">
      <div className="flex justify-center">{props.icon}</div>
      <h5 className="mb-2 text-2xl font-bold tracking-tight text-slate-600">{props.projectName}</h5>
